...
int main(){
    ...
    customerPtr->firstName,customerPtr->lastName,(*customerPtr).customerNumber,customerPtr->personal.phoneNumber,customerPtr->personal.address,customerPtr->personal.city,customerPtr->personal.state,customerPtr->personal.zipCode);
    return 0;
}
void r(){
    char *s="Ganeev";
